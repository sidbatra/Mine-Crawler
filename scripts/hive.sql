...
create external table products (url string,title string,image string,store_id string,description string) row format delimited fields terminated by '\t' stored as textfile location "s3n://denwen-mine-crawls/1334711638/products";

add file /home/hadoop/extract_products.rb;
add file /home/hadoop/reduce_products.rb;
